...
export interface ClinicalWorklistPatient {
    ...
    /** Identifies the row when `id` is not unique across it — the Doctor queue lists one
     * row per referred encounter, so the same patient can legitimately appear twice. */
