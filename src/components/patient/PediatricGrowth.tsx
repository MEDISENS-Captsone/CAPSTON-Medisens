...
interface Props { birthday?: string; age?: number | null; sex?: string; patientId: string; }
...
export function PediatricGrowth({ patientId, birthday, age, sex }: Props) {
    ...
    return <div className="col-span-2 sm:col-span-4 rounded-lg border border-[var(--brand-accent-surface)] bg-[var(--brand-soft-surface)]/40 p-3" aria-live="polite">
